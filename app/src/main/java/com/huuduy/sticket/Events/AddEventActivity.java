...
public class AddEventActivity extends AppCompatActivity {
    ...
    private AddEventTask mAuthTask = null;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void signup() {
        ...
        if (!validate()) {
            onAddEventFailed(-1, "Thông tin điền sai.");
            return;
        }
        ...
        mAuthTask = new AddEventTask(data);
        mAuthTask.execute((Void) null);
    }


    public void onAddEventSuccess(String message) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddEventActivity.this, R.style.AppTheme_Dark_Dialog);
    ...
    public void onAddEventFailed(int code, String message) {
        if (code > 0)
            progressDialog.dismiss();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    onAddEventFailed(-1, message);
                }
                if (status.contains("OK")) {
                    onAddEventSuccess(message);
                } else {
                    onAddEventFailed(1, message);
                }
            } else {
                onAddEventFailed(-2, "Xảy ra lỗi khi đăng kí");
            }
        }
